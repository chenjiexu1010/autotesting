...
import com.common.post.MultipartPost;
import com.common.post.PostParameter;
...
public class HttpHelper {
    ...
    public static String httpGetString2(String url) throws Exception {
        HttpEntity ret;
        HttpGet hg = new HttpGet(url);
        HttpClient client = new DefaultHttpClient();
        client.getParams().setParameter(CoreConnectionPNames.CONNECTION_TIMEOUT, 330 * 1000);
        client.getParams().setParameter(CoreConnectionPNames.SO_TIMEOUT, 330 * 1000);
        ...
        return EntityUtils.toString(ret, "utf8");
    }
